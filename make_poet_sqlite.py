...
def create_db():
    db = sqlite3.connect('quantangshi.db', isolation_level=None)
...
def main():
    # 删已有
    try:
        os.remove('quantangshi.db')
    except Exception as e:
        print(e)

    try:
        os.remove('quantangshi.db.zip')
    except Exception as e:
        print(e)
    ...
    # zip
    with ZipFile('quantangshi.db.zip', 'w') as myzip:
        myzip.write('quantangshi.db')
